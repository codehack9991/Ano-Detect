...
## 1 - Pre-processing
This step consists of a single file ([preprocessing.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/01_preprocessing.ipynb)). For this program to work, the dataset files must be in the "CSVs" folder in the same location as the program. The dataset files can be access  [ here ](https://drive.google.com/open?id=1-uwoKddOHgRxS8vth-nGBqBtz-qzRSAX).  (The reason that these files are given an external link is that the maximum limit of the file in the cseegit system is 10 MB)
...
# 2 - Statistics
This step consists of a single file ([statistics.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/02_statistics.ipynb)). This program examines the file "all_data.csv" and prints the statistics of attack and benign registry on this screen. It is not a prerequisite for any file. It only gives information.
...
####   a - [feature_selection_for_attack_files.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/04_1_feature_selection_for_attack_files.ipynb)
...
####  b - [feature_selection_for_all_data.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/04_2_feature_selection_for_all_data.ipynb)
...
####  a - [machine_learning_implementation_for_attack_files.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/05_1_machine_learning_implementation_for_attack_files_.ipynb)
...
####  b - [machine_learning_implementation_with_18_feature.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/05_2_machine_learning_implementation_with_18_feature.ipynb)
...
####  c -  [machine_learning_implementation_with_7_feature.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/05_3_machine_learning_implementation_with_7_feature.ipynb)
...
####  d -  [ml_f_measure_comparison.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/05_4_ml_f_measure_comparison.ipynb)
...
####  e-  [machine_learning_implementation_final.ipynb](https://cseegit.essex.ac.uk/kk17343project/Anomaly_Detection_in_Networks_Using_Machine_Learning/blob/master/05_4_machine_learning_implementation_final.ipynb)
